export const appConfig = {
    ...
    "searchVariables": {
        ...
        "language": "en-us",
        "documentContainerName": "testcontainer/pdfs_single_page",
        "searchType": "full",
    },
    "showChatbot": true,
    "showSummary": false,
    ...
    "tips": [
        ...
        { 
          "title": "Examples of questions you can ask in JTI Search (Full) ",
          "description": `
           - GDP Bahamas in 2023 million bahamian dollars
           - Real GDP change % Bahamas 2023
           - CPI (12 Months average %) Bahamas 2023
           - CPI (12 Months average %) Bahamas 2021
           - Fiscal overall balance (% of GDP) of the Bahamas in 2023
           - Unemployment rate Bahamas % 2023
           - Government debt (% of GDP) 2023
           - Smoking Incidence %
           - Daily smoking incidence %
           - Illicit market share (2007)
           - Bahamas Visitors by Month 2023`
        },
        {
          "title": "Examples of questions you can ask in JTI Search (Semantic)",
          "description": `
           - Smoking Incidence % 2019
           - Bahamas Air 2023 Visitors `
        }
      ],
